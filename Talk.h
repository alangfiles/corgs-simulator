...
const unsigned char talk_smoke[] = "This seems like a good    place to smoke, but I can't in an NES game.";
const unsigned char talk_bathroom[] = "There's a surprise for you in there, it's a secret to everybody.";
const unsigned char talk_hotdog[] = "This hot dog will give you super powers... if we get   to programming it.";
const unsigned char talk_food[] = "I can't decide. Greasy     expensive burger or greasy expensive salad?";
const unsigned char talk_bush[] = "These are nice bushes, but I don't think they'd make   good clouds.";
...
const unsigned char talk_plumber[] = "A plumber came to fix the toliet, but he's been in there for an hour. I hope he didn't fall in.";
const unsigned char talk_location[] = "This is the location you get when you register for the show last.";
