...
const unsigned char talk_pinball[] = "M-M-M-MULTIBALL!!"; //Most people prefer widebodypinball machines, but not me.\nI like them long and thin.";
...
const unsigned char talk_sprites[] = "We'd have a better crowd here if not for the\nsprite limitations.";
